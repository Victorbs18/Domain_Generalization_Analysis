# search_exp7.py — Hyperparameter search for Experiment 7.
#
# Two correlated spurious features: color + texture, same e for both.
# 4 configs matching Exp 5 proximity/diversity 2x2 design.
#
# Usage
#   python src/exp7/search_exp7.py --config A --mode irm --selection_method oracle --n_trials 50
#
# Output
#   results/exp7/search_results_{mode}_{config}_{selection_method}.json
...
from utils.selection        import (load_environments, score_oracle,
...
def run_search(args):
    ...
    out_path = (f"results/exp7/search_results"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Search — Exp 7 Two Correlated Spurious Features")
