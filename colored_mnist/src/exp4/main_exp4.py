# src/exp4/main_exp4.py
# Experiment 4 -- Number of Environments (Fixed Range {0.1, 0.2})
#
# Isolates the pure quantity effect by keeping all e values within the same fixed range {0.1, 0.2}.
#
# Usage:
#   python src/exp4/main_exp4.py --mode irm --n_envs 3 --selection_method oracle
#   python src/exp4/main_exp4.py --mode erm --n_envs 3 --selection_method oracle
...
# ---------------------------------------------------------------------------
# Environment configurations — fixed range {0.1, 0.2}
# ---------------------------------------------------------------------------
ENV_E_VALUES = {
    1: [0.15],
    2: [0.1, 0.2],
...
def get_args():
    parser = argparse.ArgumentParser(
        description="Experiment 4 -- Number of Environments (Fixed Range)")
...
def main():
    ...
    if args.mode == "erm":
        ...
        search_path = (f"results/exp4/search_results_{args.mode}_"
