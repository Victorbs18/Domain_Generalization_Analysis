...
#   python src/exp4/search_exp4.py --mode erm --n_envs 3 --selection_method oracle
...
# Args
# ---------------------------------------------------------------------------
parser = argparse.ArgumentParser(description="Experiment 4 -- Hyperparameter search")
...
out_path = f"results/exp4/search_results_{args.mode}_{args.n_envs}_{args.selection_method}.json"
