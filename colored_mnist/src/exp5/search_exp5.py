# src/exp5/search_exp5.py
# Experiment 5 -- Proximity vs Diversity 2x2
#
# Usage:
#   python src/exp5/search_exp5.py --mode irm --config A --selection_method oracle --n_trials 50
#   python src/exp5/search_exp5.py --mode irm --config B --selection_method train_domain_val --n_trials 50
#   python src/exp5/search_exp5.py --mode erm --config A --selection_method oracle
#
...
# Args
# ---------------------------------------------------------------------------
parser = argparse.ArgumentParser(description="Experiment 5 -- Hyperparameter search")
...
out_path = f"results/exp5/search_results_{args.mode}_{args.config}_{args.selection_method}.json"
